"""
Lightweight HuggingFace endpoint embeddings implementation.
This avoids the heavy PyTorch dependencies by using only remote API calls.
Based on the solution from: https://github.com/langchain-ai/langchain/discussions/24482
"""
...
class HuggingFaceEndpointEmbeddings(BaseModel, Embeddings):
    """HuggingFace endpoint embeddings without PyTorch dependencies."""
